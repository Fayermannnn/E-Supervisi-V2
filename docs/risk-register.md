...
| T-04 | Kepatuhan UU 27/2022 PDP (basis pemrosesan, retensi, enkripsi) | Tinggi | Enkripsi transit (TLS) + at-rest utk berkas observasi; retensi = arsip bukan hapus; audit menyeluruh; dokumen basis pemrosesan (pelaksanaan tugas dinas) di `deployment.md` | OPEN (perlu review hukum di Fase 5) |
